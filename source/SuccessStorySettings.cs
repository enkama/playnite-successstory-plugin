...
namespace SuccessStory
{
    ...
    public class SuccessStorySettingsViewModel : ObservableObject, ISettings
    {
        ...
        public void EndEdit()
        {
            ...
            // Update the existing PluginDatabase.PluginSettings.Settings instance so existing event
            // subscriptions are preserved (controls subscribe to PluginDatabase.PluginSettings.PropertyChanged).
